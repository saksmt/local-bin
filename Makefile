...
SRC_BIN = bin/buildkernel bin/dropcaches bin/dropswap bin/executify bin/passwd-gen bin/overlay bin/reload-idea-project bin/memusg bin/destroy bin/take bin/take-until bin/drop-until bin/unique bin/fav-deadbeef bin/fix-shebang
